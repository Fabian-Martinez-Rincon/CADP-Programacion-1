{
 ...
 1) Musculaci�n, 2) Spinning, 3) Cross Fit, 4) Libre. 
  ...
  Adem�s, se debe leer y almacenar la informaci�n de los 1000 clientes del centro de deportes. 
  De cada uno se conoce: c�digo de cliente, DNI, apellido y nombre, fecha de ingreso, 
  edad y el n�mero de actividad elegida (1..4). 
  
  Escribir un programa que invoque a m�dulos para resolver cada inciso: 
a) Lea la informaci�n de los clientes y los almacene en una estructura de datos. La lectura finaliza con el c�digo de cliente -1 y los clientes se leen ordenados por c�digo de cliente. Como m�ximo el centro de deportes atiende a 1000 clientes.
...
c) Agregar un nuevo cliente, con el c�digo siguiente al �ltimo c�digo de cliente ingresado, para el cliente Juan Garc�a con DNI 11111, de 20 a�os de edad y que eligi� la actividad Libre, en el d�a de la fecha.
d) Informe el nombre y apellido del cliente con un c�digo de cliente determinado.
e) Informe el nombre y apellido de los clientes con fecha de ingreso en un a�o determinado.
f) Sabiendo que el c�digo de cliente 3300 no existe, inserte un nuevo cliente con ese c�digo para el cliente Ana Paus  de 45 a�os y actividad elegida Musculaci�n, en el d�a de la fecha.
g) Elimine el cliente correspondiente a un c�digo que se lee. 
...
var
  ...
  {datos cliente nuevo}
  c:cliente;
  {variables para dimensi�n l�gica y posici�n a insertar/borrar}

...
Código con las correcciones de los incisos a) y b): agrega calcularPromedio := prom; y reemplaza las dos
invocaciones a calcularPromedio por una sola, guardando el resultado en la variable promedio: real.}
